 ...
 */
public class MDKBaseRichDateWidget<T extends MDKInnerWidget & MDKRestorableWidget & HasValidator & HasMdkDelegate> extends MDKBaseRichWidget<T> implements HasValidator {
