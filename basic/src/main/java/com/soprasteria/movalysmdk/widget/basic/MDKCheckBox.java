 ...
 */
public class MDKCheckBox extends AppCompatCheckBox implements MDKWidget, HasValidator, HasLabel, HasChecked, HasCheckedTexts, HasDelegate, HasChangeListener {
