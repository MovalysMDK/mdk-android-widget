...
import com.soprasteria.movalysmdk.widget.basic.command.PhoneWidgetCommand;
 ...
 * </p>
 */
public class MDKPhone extends AppCompatEditText implements MDKWidget, MDKRestorableWidget, HasText, HasTextWatcher, HasHint, HasValidator, HasCommands, HasLabel, HasDelegate {
    ...
    public void onClick(View v) {
        ...
        if (phoneNumber != null && phoneNumber.length() > 0) {
            // invoke command
            ((PhoneWidgetCommand)this.commandDelegate.getWidgetCommand(v.getId())).execute(this.getContext(), phoneNumber);
        }
    }

    @Override
    public int[] getValidators() {
        return new int[] {R.string.mdkwidget_mdkedittext_validator_class, R.string.mdkwidget_mdkphone_validator_class};
    }
